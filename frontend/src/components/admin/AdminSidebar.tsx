...
export default function AdminSidebar({ isOpen, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed inset-y-0 left-0 z-50 w-64 bg-prestige-card shadow-prestige-xl border-r border-prestige-border transform transition-transform duration-300 ease-in-out
        ${isOpen ? 'translate-x-0' : '-translate-x-full'}
        lg:translate-x-0 lg:static lg:inset-0 lg:z-auto lg:flex-shrink-0
      `}>
        <div className="flex flex-col h-full">
          {/* Logo */}
          <div className="flex items-center justify-between px-6 py-4 border-b border-prestige-border bg-gradient-to-r from-prestige-gold/5 to-prestige-gold-light/5">
            <div className="flex items-center space-x-3">
              <div className="relative">
                {/* Logo background effect */}
                <div className="absolute inset-0 bg-gradient-to-br from-prestige-gold/20 to-prestige-gold-light/20 rounded-lg blur-sm"></div>
                <div className="relative bg-prestige-card p-1.5 rounded-lg shadow-prestige-sm">
                  <Image
                    src="/logo.png"
              ...
              <div>
                <h1 className="text-lg font-prestige-sans font-bold text-prestige-black">Admin Panel</h1>
                <p className="text-xs text-prestige-gray font-prestige-sans">Management Dashboard</p>
              </div>
            </div>
            <button
              onClick={onClose}
            ...
            {sidebarItems.map((item) => {
              ...
              return (
                <Link
                  ...
                  href={item.href}
                  className={`
                    group flex items-center px-3 py-3 text-sm font-prestige-sans font-medium rounded-xl transition-all duration-300 transform hover:scale-105
                    ${isActive 
